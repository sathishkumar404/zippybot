...
const { AttachmentLayoutTypes, CardFactory ,MessageFactory,InputHints} = require('botbuilder');
const { ChoicePrompt, ComponentDialog, DialogSet, DialogTurnStatus,ConfirmPrompt, WaterfallDialog } = require('botbuilder-dialogs');
...
class MainDialog extends ComponentDialog {
  ...
  async confirmStep(stepContext) { 
           await stepContext.context.sendActivity(basicText.better)  
        ...
        const messageText = basicText.reload; 
