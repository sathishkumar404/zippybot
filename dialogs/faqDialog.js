...
const { InputHints, MessageFactory,ActivityHandler,BotFrameworkAdapter,QnAMaker } = require('botbuilder');
    ...
    constructor(id) {
     ...
     async askQuestion(stepContext) {  
        ...
        if (!bookingDetails.email) {
            const messageText ='Hey !! Ask me a question and I will try to answer it.';
